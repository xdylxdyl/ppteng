...
<script
	src="<%=request.getContextPath() %>/r/j-src/kill/killer_police_1.0/accept.js?v=${frontVersion}"></script>
<script
	src="<%=request.getContextPath() %>/r/j-src/kill/killer_police_1.0/view.js?v=${frontVersion}"></script>
<script
