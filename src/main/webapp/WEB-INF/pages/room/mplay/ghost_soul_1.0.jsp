		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="help_area">
				<div class="hero-unit">
					...
					<p>
						<a href="http://bbs.ptteng.com/forum.php?mod=viewthread&tid=2327"
							class="text-warning" target="_blank">2.[捉鬼-魂版]规则 &raquo;</a>
					</p>
...
<script
	src="<%=request.getContextPath() %>/r/j-src/game/ghost/soul/1.0/ghost_soul_1.0.js?v=${frontVersion}"></script>
<script
