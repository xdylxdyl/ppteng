...
<div class="col-md-12 ">
	<div class="panel panel-default" id="footController">
		...
		<div class="panel-body">
			...
			<div ng-repeat="right in rights" class="btn-group dropup">			
					<button type="button" class="btn btn-primary" right="{{right}}" ng-click="processRight(right)" ng-bind="right|rightConvert"></button>
			</div>
