	...
	$(document)
			.ready(
					function() {
						...
						$("#btn_userLogin_submit")
								.click(
										function() {
											$("#btn_userLogin_submit").attr(
													"disabled", "disabled");
											$
													.ajax({
														type : 'POST',
...
<BODY>
	...
	<div id="user_login">
		...
		<div>
			...
			<date:date pattern="yyyy年 MM月dd日  HH时mm分 " value="4564654654654"></date:date>
			
			<fmt:formatNumber pattern="0.00"
											value="300"></fmt:formatNumber>
		</div>
