...
var ghostSimpleModel = {
    ...
    hint:{
        topic:"【系统消息】请耐心等英明的国王出题,卡片格式:第一个词是水民卡,第二个词是幽灵卡,中间以逗号隔开,水民卡和幽灵卡是两个相近词.如('桔子,橙子')国王请在指令里选择出题",
...
var simpleRightView = {
    ...
    commandRight:function (right) {
        rightView.showCommandRight(right, ghostSimpleModel.rightContent[right]);
